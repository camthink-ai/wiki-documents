  ...
  ['@docusaurus/plugin-client-redirects',
    {
      redirects: [
        ...
        { from: '/docs/ai-application/cinfer-ai-Inference-service/quick-start', to: '/docs/software/cinfer-inference-service/quick-start' },
        { from: '/docs/ai-application/cinfer-ai-Inference-service/user-guide', to: '/docs/software/cinfer-inference-service/user-guide' },
        { from: '/docs/ai-application/cinfer-ai-Inference-service/dev-guide', to: '/docs/software/cinfer-inference-service/dev-guide' },
        { from: '/docs/ai-application/cinfer-ai-Inference-service/application-integration/beaveriot-integration', to: '/docs/software/cinfer-inference-service/application-integration/beaveriot-integration' },
