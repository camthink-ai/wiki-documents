...
- NE101 为定焦模组,提供两种 FOV 镜头:**60°(标称工作距离 15cm)** 与 **120°(标称工作距离 8cm)**
- 安装时镜头需**正对字轮**,距离在支架标称范围内
- 字轮较小的老式表,注意画面占比(字轮区域 ≥ 1/3 画面)

### 安装距离(60° / 120° FOV)

两种镜头均为出厂定焦,**标称工作距离**是对焦基准,实际安装距离不必严格对齐——可在标称值附近小范围浮动,以实拍字轮清晰为准。安装时通过支架将镜头对准字轮,使字轮区域占画面 **1/3 以上**(推荐 1/2):
...
**原理**:画面覆盖宽 ≈ 2 × 标称工作距离 × tan(FOV/2)。60° 镜头在 15cm 处覆盖约 17cm,120° 镜头在 8cm 处覆盖约 28cm;字轮占画面比例越高,OCR 像素密度越充足。

**安装验证**:支架固定前先手动抓拍一张,确认字轮清晰、无反光、占比合适,再锁定支架螺丝;若安装距离偏离标称值,以抓拍效果为准微调。
...
| <img src="/img/solutions/ne101-bracket.webp" alt="支架" width="40" style={{display: 'block', margin: '0 auto', borderRadius: '6px'}} /> | 2 | 水表支架 | NE101 官方配件 | 每表 1 套 | 固定镜头与表盘相对位置 |
| <img src="/img/Overview/NG45xx/NG45XX.png" alt="NG4500" width="40" style={{display: 'block', margin: '0 auto', borderRadius: '6px'}} /> | 3 | [平台主机 NG4500 AI Box](https://www.camthink.ai/product/neoedge-ai-box-ng4500/)(推荐,运行 NeoMind) | Linux 主机 / NG4500 | 1 台 | 接收、OCR、规则、数据出口 |
