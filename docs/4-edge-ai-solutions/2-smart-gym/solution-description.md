...
在场馆顶部部署一台 CamThink **NeoEyes NE503** 边缘 AI 相机(Hailo-15H,20 TOPS NPU),即可覆盖 10~20 人的中型健身区域。相机端并发运行人体检测、17 关键点姿态、人脸检测与人脸特征四类模型,完成会员身份识别与轨迹跟踪;**NeoMind 平台**侧的 gym-tracker 扩展负责会员库匹配、器械区域判定、动作识别计数与训练报告生成。
