...
<div className="docs-home-container">
  ...
  <div className="community-grid">
    ...
    <a href="https://www.hackster.io/camthink" target="_blank" rel="noopener noreferrer" className="community-card">
      <span className="cc-icon" style={{background: 'rgba(242,74,0,0.10)', color: '#F24A00'}}><svg viewBox="0 0 24 24" fill="currentColor"><rect x="4" y="3" width="4.4" height="18" rx="1.4"/><rect x="15.6" y="3" width="4.4" height="18" rx="1.4"/><rect x="6.5" y="9.8" width="11" height="4.4" rx="1.4"/></svg></span>
      <h3>Hackster.io</h3>
      <p>社区项目与创意玩法展示。</p>
    </a>
