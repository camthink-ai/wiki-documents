...
`hailo_ipc_sdk` 是 NE503 容器应用的 Python SDK，提供 8 个核心模块。安装方式参见[应用开发指南](./1-app-reference.md#3-sdk-安装)。
...
| `CAMERA_CONTROL_ENDPOINT` | `unix:///run/aipc/camera-control.sock` | 摄像头控制端点 |

| `AIPC_HOST_PREFIX` | `""` | 宿主路径前缀 |
...
- [应用开发指南](./1-app-reference.md) — 项目创建、app.yaml 配置、部署流程
- [AI 推理服务](../6-reference/service-reference/0-ai-runtime.md) — AI Runtime 架构与配置
- [事件总线](../6-reference/service-reference/2-event-bus.md) — 事件系统详细说明
