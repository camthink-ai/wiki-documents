...
- [应用开发指南](../3-software-platform/1-app-development.md) — AI 应用开发流程
- [SDK 参考](../3-software-platform/2-sdk-reference.md) — Python/CLI SDK 使用说明
- [CLI 工具指南](../3-software-platform/4-cli-guide.md) — 命令行工具 `aipc-cli` 使用
- [RESTful API](../3-software-platform/5-restful-api.md) — RESTful API 接口参考
