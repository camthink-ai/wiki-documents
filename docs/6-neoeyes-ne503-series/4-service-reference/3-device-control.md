...
- [平台架构](../3-software-platform/0-platform-architecture.md) — 四层架构总览及服务间通信
- [RESTful API](../3-software-platform/5-restful-api.md) — HTTP API 网关转发规则
- [Event Bus](2-event-bus.md) — 事件总线服务参考
- [CLI Guide](../3-software-platform/4-cli-guide.md) — 命令行设备控制工具
