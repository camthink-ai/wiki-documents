...
> 以下为应用层简化错误码。系统服务层的详细错误码请参考[故障排查指南](./0-troubleshooting.md#13-错误码表)。
...
- [开发指南](../5-platform-development/0-development-guide.md) — 开发环境搭建与工作流
- [故障排查](./0-troubleshooting.md) — 完整故障排查手册
- [配置参考](./1-config-reference.md) — 所有服务配置文件参数
- [CLI 工具](../3-software-platform/4-cli-guide.md) — 命令行工具使用说明
