...
- [平台架构](../3-software-platform/0-platform-architecture.md) -- 四层分层架构与核心服务总览
- [App Manager 服务](../4-service-reference/1-app-manager.md) -- 容器生命周期管理详细说明
- [AI Runtime 服务](../4-service-reference/0-ai-runtime.md) -- NPU 推理调度与模型管理详细说明
- [Event Bus 服务](../4-service-reference/2-event-bus.md) -- 发布/订阅消息总线详细说明
- [故障排查](./0-troubleshooting.md) -- 常见问题与排查方法
