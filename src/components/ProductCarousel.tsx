...
interface ProductLink {
    label: JSX.Element;
    url: string; // 相对 baseUrl 的路径，如 'docs/neomind/...'
    icon: string;
}
...
// 注意：NE302 的专属文档（docs/neoeyes-ne302-series）尚未发布，
// 链接暂指向 NE301 系列文档（NE300 家族共用文档与设备类型）；
// NE302 文档上线后请替换为对应链接。
const NE302_LINKS: ProductLink[] = [
    ...
    const products: Product[] = [
        {
            ...
            image: 'img/home/carousel/neomind.webp',
            links: [
        ...
        },
        {
            id: 'ne302',
            badge: 'NEW',
            name: 'NeoEyes NE302 AI Camera',
            title: <Translate id="carousel.ne302.title">NeoEyes NE302 (AI Camera)</Translate>,
            tagline: <Translate id="carousel.ne302.tagline">NeoEyes NE300 家族新品 · 低功耗边缘 AI 相机</Translate>,
            description: <Translate id="carousel.ne302.desc">延续 NE300 家族的低功耗边缘 AI 设计，支持本地实时推理，可经 MQTT/Webhook 无缝接入 NeoMind 平台，完成设备管理、规则联动与数据可视化。</Translate>,
            image: 'img/home/carousel/ne302.webp',
            links: NE302_LINKS,
        },
        {
            id: 'ne503',
            badge: 'NEW',
            name: 'NeoEyes NE503 AI Camera Pro',
            ...
            image: 'img/home/carousel/ne503.webp',
            links: [
        ...
        },
        {
            ...
            image: 'img/home/carousel/ne301.webp',
            links: [
                { label: <Translate id="carousel.link.overview">产品概述</Translate>, url: 'docs/neoeyes-ne301-series/overview', icon: 'overview' },
                { label: <Translate id="carousel.link.quickstart">快速入门</Translate>, url: 'docs/neoeyes-ne301-series/quick-start', icon: 'quickstart' },
                { label: <Translate id="carousel.link.devguide">开发指南</Translate>, url: 'docs/neoeyes-ne301-series/NE300-MB01-development-board/dev-guide', icon: 'devguide' },
        ...
        },
        {
            ...
            image: 'img/home/carousel/ne101.webp',
            links: [
        ...
        },
        {
            ...
            image: 'img/home/carousel/ng4500.webp',
            links: [
                        ...
                        <div className="slide-content">
                            ...
                            <div className="resource-grid">
                                {product.links.map((link, idx) => (
                                    <Link key={idx} to={`${base}${link.url}`} className="resource-card">
