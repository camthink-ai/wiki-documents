...
- [Platform Architecture](../../3-platform-development/0-platform-architecture.md) — Four-layer architecture overview and inter-service communication
- [RESTful API](../../5-system-integration/1-restful-api.md) — HTTP API gateway forwarding rules
- [Event Bus](2-event-bus.md) — Event bus service reference
- [CLI Guide](../../5-system-integration/3-cli-guide.md) — Command-line device control tools
