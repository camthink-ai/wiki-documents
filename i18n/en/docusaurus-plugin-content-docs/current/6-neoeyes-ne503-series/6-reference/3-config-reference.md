...
- [Platform Architecture](../3-platform-development/0-platform-architecture.md) -- Four-layer architecture and core service overview
- [App Manager Service](./service-reference/1-app-manager.md) -- Container lifecycle management details
- [AI Runtime Service](./service-reference/0-ai-runtime.md) -- NPU inference scheduling and model management details
- [Event Bus Service](./service-reference/2-event-bus.md) -- Pub/Sub message bus details
- [Troubleshooting](./2-troubleshooting.md) -- Common issues and troubleshooting methods
