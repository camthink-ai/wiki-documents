...
| Fill Light Interface | Supports IR fill light (supported), White fill light (reserved). Note: Fill light connector is an internal module, not a user-facing external interface |
