...
- [Platform Architecture](./0-platform-architecture.md) — Understand system design and data flow
...
- [CLI Tool](./4-cli-guide.md) — aipc-cli complete command reference
- [Container Application Management](../4-service-reference/1-app-manager.md) — App Manager in-depth analysis
