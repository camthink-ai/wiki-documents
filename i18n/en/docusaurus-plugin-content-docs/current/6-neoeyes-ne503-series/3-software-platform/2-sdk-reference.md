...
`hailo_ipc_sdk` is the Python SDK for NE503 container applications, providing 8 core modules. For installation instructions, see the [App Development Guide](./1-app-development.md#3-sdk-installation).
...
- [App Development Guide](./1-app-development.md) — Project creation, app.yaml configuration, and deployment workflow
- [AI Inference Service](../4-service-reference/0-ai-runtime.md) — AI Runtime architecture and configuration
- [Event Bus](../4-service-reference/2-event-bus.md) — Detailed event system documentation
