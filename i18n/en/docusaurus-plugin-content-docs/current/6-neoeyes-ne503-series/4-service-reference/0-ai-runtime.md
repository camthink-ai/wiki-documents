...
- [App Development Guide](../3-software-platform/1-app-development.md) — AI application development workflow
- [SDK Reference](../3-software-platform/2-sdk-reference.md) — Python/CLI SDK usage guide
- [CLI Tool Guide](../3-software-platform/4-cli-guide.md) — Command-line tool `aipc-cli` usage
- [RESTful API](../3-software-platform/5-restful-api.md) — RESTful API interface reference
