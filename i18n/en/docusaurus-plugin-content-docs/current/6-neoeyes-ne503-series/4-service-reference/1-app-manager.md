...
| **security** | `seccomp_profile`, `readonly_rootfs`, `capabilities_drop` | Security sandbox configuration (see [Config Reference](../6-advanced-reference/1-config-reference.md#4-app-manageryaml)) |
...
- [Application Development Guide](../3-software-platform/1-app-development.md) — Complete application development workflow
...
- [CLI Tool Guide](../3-software-platform/4-cli-guide.md) — aipc-cli command-line tool
