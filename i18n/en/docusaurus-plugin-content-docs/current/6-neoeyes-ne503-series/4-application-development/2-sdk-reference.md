...
`hailo_ipc_sdk` is the Python SDK for NE503 container applications, providing 8 core modules. For installation instructions, see the [App Development Guide](./1-app-reference.md#3-sdk-installation).

## Quick Start

```python
from hailo_ipc_sdk import InferenceClient, FdMediaClient, EventClient
...
| `CAMERA_CONTROL_ENDPOINT` | `unix:///run/aipc/camera-control.sock` | Camera control endpoint |

| `AIPC_HOST_PREFIX` | `""` | Host path prefix |
...
- [App Development Guide](./1-app-reference.md) — Project creation, app.yaml configuration, and deployment workflow
- [AI Inference Service](../6-reference/service-reference/0-ai-runtime.md) — AI Runtime architecture and configuration
- [Event Bus](../6-reference/service-reference/2-event-bus.md) — Detailed event system documentation
