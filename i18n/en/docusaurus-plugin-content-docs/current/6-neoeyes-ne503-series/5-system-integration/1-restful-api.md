...
- [Platform Architecture](../3-platform-development/0-platform-architecture.md) -- NE503 four-layer architecture and service dependencies
- [App Development](../4-application-development/1-app-reference.md) -- Application development guide based on Platform API
- [SDK Reference](../4-application-development/2-sdk-reference.md) -- Python SDK complete API reference
- [CLI Guide](./3-cli-guide.md) -- aipc-cli command-line tool usage guide
